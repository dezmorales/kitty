...
class Rail
  ...
  def create_cargo_wagon
    ...
    @rail_wagons << CargoWagon.new(wagon_number, wagon_capacity)
  ...
  def create_passenger_wagon
    ...
    @rail_wagons << PassengerWagon.new(wagon_number, wagon_capacity)
  ...
  def train_wagon_list
    ...
    train.each_wagon do |wagon|
      ...
      "количество свободного места - #{wagon.free_place}, количество занятого места - #{wagon.busy}."
    end
  end
  ...
  def menu
    ...
    puts '15. Занять место или объем в вагоне'
    puts '16. Посмотреть список вагонов у поезда'
    puts '17. Посмотреть список поездов на станции'
    puts '18. Выход'
  end
